...
const TodoList:FC<TodoListProps> = ({todos,switchTodo}) => {
    return (
            todos.length > 1 ? (
                <div className="col-span-12 flex items-center justify-center bg-gray-900">
                    ...
                    <table className="table text-gray-400 border-separate space-y-6 text-sm">
                        ...
                        <tr>
                            ...
                            <th className="p-3"><Button types={'add'} content={<Link className="px-4 px-4 py-2" to='/progress'>In progress</Link>}/></th>
                            <th className="p-3"><Button types={'add'} content={<Link className="px-4 px-4 py-2" to='/done'>Done</Link>}/></th>
                        </tr>
                        </thead>
                    </table>
                    <table className="table text-gray-400 border-separate space-y-6 text-sm">
